...
<div class="post-author clearfix">
	<h3 class="post-author_h"><?php echo "napisane przez"; ?> <?php the_author_posts_link() ?></h3>
	...
	<?php the_author_meta('description') ?> 
		<div class="post-author_link">
			<p><?php echo "zobacz wszystkie aktualności napisane przez"; ?>: <?php the_author_posts_link() ?></p>
		</div>
	</div>
</div><!--.post-author-->
