...
<head>
	...
	?>
	<style type='text/css'>
		<?php if (of_get_option('header_color') !='') {
			$header_styling = of_get_option('header_color');
			update_option('child_header_color', $header_styling);
			$bg_header .= "background-color:".$header_styling;
		} else {
			$header_styling = of_get_option('header_background');

			if ($header_styling['image'] != '') {
				$bg_header = "background-image:url(".$header_styling['image']. "); background-repeat:".$header_styling['repeat']."; background-position:".$header_styling['position']."; background-attachment:".$header_styling['attachment'];
			}
			if ($header_styling['color'] != '') {
				$bg_header = "background-color:".$header_styling['color'];
			} else {
				if (get_option('child_header_color') && !is_array(get_option('child_header_color')) ) {
					$bg_header.= "background-color:".get_option('child_header_color');
				}
			}
		} ?>
		.header .nav-wrap.isStuck {	<?php echo $bg_header; ?> }
	</style>
...
<body <?php body_class(); ?>>
	<div id="motopress-main" class="main-holder <?php echo (of_get_option('stickup_menu', 'false')=="false") ? '' : 'stuck'; ?>">
