<?php if ( resume_manager_user_can_view_resume( $post->ID ) ) : ?>
	<div class="single-resume-content">
		...
		<div class="resume-aside">
			...
			<p class="name"><?php // the_title(); ?> <?php the_candidate_photo(); ?></p>
			...
			<div class="clear"></div>
			<p class="video"><?php the_candidate_video(); ?></p>
							...
							<?php 
								foreach( $items as $item ) : ?>
									...
									<dt>
										...
										<h3><?php printf( __( '%s at %s', 'job_manager' ), '<strong class="qualification">' . esc_html( $item['qualification'] ) . '</strong>', '<strong class="location">' . esc_html( $item['location'] ) . '</strong>' ); ?></h3>
									</dt>
									<dd>
						...
						<div class="span6">
							...
							<?php 
								foreach( $items as $item ) : ?>
									...
									<dt>
										<small class="date"><?php echo esc_html( $item['date'] ); ?></small>
										<h3><?php printf( __( '%s at %s', 'job_manager' ), '<strong class="job_title">' . esc_html( $item['job_title'] ) . '</strong>', '<strong class="employer">' . esc_html( $item['employer'] ) . '</strong>' ); ?></h3>
									</dt>
									<dd>
										<?php echo wpautop( wptexturize( $item['notes'] ) ); ?>
									</dd>
