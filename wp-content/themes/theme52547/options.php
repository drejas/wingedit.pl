...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '13px', 'lineheight' => '25px', 'face' => 'Raleway', 'style' => 'normal', 'character'  => 'latin', 'color' => '#777777'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '65px', 'lineheight' => '77px', 'face' => 'Raleway', 'style' => 'normal', 'character'  => 'latin', 'color' => '#323232'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '50px', 'lineheight' => '65px', 'face' => 'Raleway', 'style' => 'normal', 'character'  => 'latin', 'color' => '#323232'));

			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '40px', 'lineheight' => '52px', 'face' => 'Raleway', 'style' => 'normal', 'character'  => 'latin', 'color' => '#323232'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '35px', 'lineheight' => '45px', 'face' => 'Raleway', 'style' => 'normal', 'character'  => 'latin', 'color' => '#323232'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '30px', 'lineheight' => '42px', 'face' => 'Raleway', 'style' => 'normal', 'character'  => 'latin', 'color' => '#323232'));

			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '25px', 'lineheight' => '42px', 'face' => 'Lato', 'style' => 'normal', 'character'  => 'latin', 'color' => '#323232'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '40px', 'lineheight' => '48px', 'face' => 'Raleway', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '19px', 'lineheight' => '24px', 'face' => 'Raleway', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '14px', 'lineheight' => '16px', 'face' => 'Raleway', 'style' => 'normal', 'character'  => 'latin', 'color' => '#777777'),
								'disable' => 'true');
...
// ---------------------------------------------------------
		...
		$options['login_display_id'] = array( "name" => __('Display login links?', CURRENT_THEME),
					"desc" => __('Display login links in the menu?', CURRENT_THEME),
					"id" => "login_display_id",
					"std" => "yes",
					"type" => "radio",
					"options" => array(
		...
		$options['log_out'] = array( "name" => __('Logoff title.', CURRENT_THEME),
		...
		$options['sign_in'] = array( "name" => __('Authentication title (login).', CURRENT_THEME),
