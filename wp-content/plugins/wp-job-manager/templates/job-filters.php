...
<form class="job_filters">
	...
	<div class="search_jobs">
		...
		<div class="search_keywords">
			...
			<input type="text" name="search_keywords" id="search_keywords" placeholder="Słowo kluczowe" value="<?php echo esc_attr( $keywords ); ?>" />
		</div>

		<div class="search_location">
			<label for="search_location"><?php _e( 'Location', 'wp-job-manager' ); ?></label>
			<input type="text" name="search_location" id="search_location" placeholder="Lokalizacja" value="<?php echo esc_attr( $location ); ?>" />
		</div>
